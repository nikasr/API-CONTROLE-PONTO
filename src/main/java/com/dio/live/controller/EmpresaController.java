...
public class EmpresaController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Empresa>  getEmpresaByID(@PathVariable("id") Long idEmpresa) throws Exception {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity deleteByID(@PathVariable("id") Long idEmpresa) throws Exception {
        try {
